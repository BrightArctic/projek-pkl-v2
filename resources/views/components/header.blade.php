    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown dropdown-list-toggle">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-list-content dropdown-list-message" id="messageContent">
        ...
        <script>
            // JavaScript code to fetch and display messages
$(document).ready(function() {
    // Make an AJAX request to fetch messages
    $.ajax({
        url: '/fetch-messages', // Replace with your endpoint to fetch messages
        method: 'GET',
        success: function(response) {
            // Iterate through the messages and append them to #messageContent
            response.messages.forEach(function(message) {
                var messageItem = `
                    <a href="#" class="dropdown-item dropdown-item-unread">
                        <div class="dropdown-item-avatar">
                            <img alt="image" src="${message.avatar}" class="rounded-circle">
                            <div class="${message.online ? 'is-online' : ''}"></div>
                        </div>
                        <div class="dropdown-item-desc">
                            <b>${message.sender}</b>
                            <p>${message.content}</p>
                ...
                $('#messageContent').append(messageItem);
            });
        },
    ...
    $(document).ready(function() {
        ...
        function fetchMessages() {
            ...
            $.ajax({
                ...
                method: 'GET',
                success: function(response) {
                    // Iterate through the messages and append them to the dropdown menu
                    response.messages.forEach(function(message) {
                        var messageItem = `
                            <a href="#" class="dropdown-item dropdown-item-unread">
                                <div class="dropdown-item-avatar">
        ...
        // Call the fetchMessages function when the document is ready
        fetchMessages();
    });
</script>
